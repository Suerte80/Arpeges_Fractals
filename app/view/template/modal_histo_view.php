<div id="modal-histo" class="modal is-hidden" role="dialog" aria-modal="true">
    <div class="modal-inner">
        ...
        <button id="button-clear" class="button-glow is-hidden" type="button">Effacer Historique</button>
    </div>
</div>